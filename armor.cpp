...
void drawUpperArmArmor() {
    ...
    const float armScale = 0.14f;
    const float armorRadius = 0.8f * armScale;
    Vec3f shoulderPos = { 0.0f, 0.0f, 0.1f * armScale };
